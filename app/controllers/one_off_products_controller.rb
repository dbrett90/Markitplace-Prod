class OneOffProductsController < ApplicationController
    ...
    def one_off_product_params
        params.require(:one_off_product).permit(:name, :description, :product_id, :price, :partner_name, :user_id, :calories, :fats, :servings, :created_at, :updated_at, :stripe_id, :is_trial, :thumbnail)
    end
